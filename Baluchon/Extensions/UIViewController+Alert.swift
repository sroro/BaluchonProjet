...
//       }
    ...
    func alertTranslate() {
        let alertVC = UIAlertController(title: "Error", message: "Entrez du texte", preferredStyle: .alert)
              alertVC.addAction(UIAlertAction(title: "Ok", style: .cancel, handler: nil))
              present(alertVC , animated: true, completion: nil)
          }
    
    func alertCurrency() {
    let alertVC = UIAlertController(title: "Error", message: "Entrez un montant correcte", preferredStyle: .alert)
          alertVC.addAction(UIAlertAction(title: "Ok", style: .cancel, handler: nil))
          present(alertVC , animated: true, completion: nil)
      }
}

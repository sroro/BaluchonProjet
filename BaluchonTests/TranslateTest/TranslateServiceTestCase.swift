...
class TranslateServiceTestCase: XCTestCase {
  ...
  func testgetWeatherReceiveNoData(){
  let translate = TranslateService(session: TestFakeURLSession(data: nil, response: nil, error: TestFakeResponseData.error ))
  ...
  func testgetWeatherReceiveGoodDataButResponseKO() {
      ...
      let translate = TranslateService(session: TestFakeURLSession(data:TestFakeResponseData.fixerCorrectData , response: TestFakeResponseData.responseKO , error: nil))
